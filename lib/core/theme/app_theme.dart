...
class AppThemes {
  static ThemeData lightTheme(){
    ...
    focusedBorder: OutlineInputBorder(
      ...
      borderSide: BorderSide(
        color: Color(0xFF71B2FF), // Set focused border color
  ...
  floatingLabelStyle: TextStyle(
    color: Color(0xFF71B2FF), // Input text color, same as label
  ),
...
//     ),
  ...
  onPrimary: Color(0xFF000000), // Text color on primary background (black)
  onSecondary: Color(0xFF000000), // Text color on secondary background (black)
